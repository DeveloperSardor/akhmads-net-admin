...
export function PendingBroadcastsPage({
  setModal,
}: {
  ...
  const totalUsers = broadcasts.reduce(
    (acc, b) => acc + (b.targetCount || 0),
    0,
  );
  const totalBudget = broadcasts.reduce(
      ...
      <div className="page-head" style={{ marginBottom: 40 }}>
        <div className="page-head-left">
          ...
          <p className="section-sub" style={{ fontSize: 16 }}>
            ...
            broadcast ko'rib chiqishni kutmoqda
          </p>
        </div>
        ...
        <div className="elite-stat-box">
          ...
          <div style={{ marginTop: 8 }}>
            ...
            <div
              style={{ fontSize: 12, color: "var(--text-muted)", marginTop: 4 }}
            >
              Kutilayotgan auditoriya qamrovi
            </div>
          </div>
        </div>
        <div className="elite-stat-box">
        ...
        >
          <div>
            ...
            <p className="elite-chart-sub">
              Xabar mazmuni va auditoriyasini tekshiring
            </p>
          </div>
          <div
            className="elite-stat-icon-wrap"
                  ...
                  <td colSpan={6}>
                    ...
                    >
                      ...
                      <p className="elite-empty-text">
                        Hozirda moderatsiya uchun yangi broadcastlar yo'q.
                      </p>
                    </div>
                  </td>
                </tr>
                            ...
                            style={{
                              ...
                              background:
                                b.type === "POKAZ"
                                  ? "rgba(59, 130, 246, 0.1)"
                                  : "rgba(16, 185, 129, 0.1)",
                              color: b.type === "POKAZ" ? "#3b82f6" : "#10b981",
                              padding: "2px 8px",
                              borderRadius: 6,
                              fontWeight: 700,
                            }}
                    ...
                    <td>
                      ...
                      >
                        ...
                        <button
                          ...
                          title="Rad etish"
                          onClick={() =>
                            setModal({ type: "reject-broadcast", data: b })
                          }
                          style={{
