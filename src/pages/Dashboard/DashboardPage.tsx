...
export function DashboardPage() {
  ...
  const totalSpent =
    analyticsData?.chartData?.reduce((sum, d) => sum + d.spent, 0) ?? 0;
  ...
  return (
    <div className="elite-analytics-wrap">
      ...
      <div className="responsive-grid grid-2-1" style={{ alignItems: "start" }}>
        ...
        <div className="elite-card" style={{ padding: 32 }}>
          <div style={{ marginBottom: 32 }}>
            ...
            >
              Moderatsiya va kutilayotgan ishlar
            </p>
          </div>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  ...
                  <div>
                    ...
                    >
                      {pendingAdsCount} ta reklama kutilmoqda
                    </div>
                    <div
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  ...
                  <div>
                    <div
                      style={{ fontSize: 15, fontWeight: 700, color: "#fff" }}
                    >
                      {pendingBotsCount} ta bot kutmoqda
                    </div>
                    <div
                      style={{ fontSize: 13, color: "rgba(255,255,255,0.5)" }}
                    >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  ...
                  <div>
                    <div
                      style={{ fontSize: 15, fontWeight: 700, color: "#fff" }}
                    >
                      {pendingWithdrawalsCount} ta to'lov
                    </div>
                    <div
                      style={{ fontSize: 13, color: "rgba(255,255,255,0.5)" }}
                    >
      ...
      <div className="elite-card" style={{ marginTop: 40, padding: 32 }}>
        ...
        {/* Summary row */}
        <div className="responsive-grid grid-3" style={{ marginBottom: 28 }}>
          {[
            {
              label: "Jami aylanma",
      ...
      <div style={{ marginTop: 40 }}>
        <div style={{ marginBottom: 20 }}>
          ...
          >
            Real-vaqt rejimida platforma xabarlari va voqealar
          </p>
        </div>
        <SystemTerminal />
      </div>
