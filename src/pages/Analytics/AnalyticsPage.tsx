      ...
      <div className="elite-chart-header">
        <div>
          ...
          <p className="elite-chart-sub">
            So'nggi 7 kun — taassurotlar va daromad trendi
          </p>
        </div>
        <div
...
export function AnalyticsPage() {
  ...
  const totalSpent =
    analytics?.chartData?.reduce((sum, d) => sum + d.spent, 0) ?? 0;
      ...
      <div className="elite-analytics-wrap">
        <div className="elite-empty-state" style={{ padding: "100px 0" }}>
          ...
          <p className="elite-empty-text">
            Analitika ma'lumotlarini yuklash imkoni bo'lmadi. Keyinroq qayta
            urinib ko'ring.
          </p>
        </div>
      </div>
        ...
        {eliteStats.map((s, i) => (
          ...
          >
            ...
            >
              ...
              <div
                className={`elite-trend-badge ${s.up ? "elite-trend-up" : "elite-trend-down"}`}
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: 4,
        ...
        <div className="elite-card">
          <div className="elite-chart-header">
            <div>
              ...
              <p className="elite-chart-sub">
                Reklama turlari bo'yicha ulush (foizda)
              </p>
            </div>
            <div
              className="elite-stat-icon-wrap"
        ...
        <div className="elite-card">
          ...
          <div className="elite-dist-list">
            {[...displayCategories]
              ...
              .map((cat, i) => (
                <div
                  className="elite-dist-item"
                  key={i}
                  style={{ opacity: isEmpty ? 0.35 : 1 }}
                >
                  <div className="elite-dist-label-group">
                    <div
                      className="elite-dist-dot"
      ...
      <div className="elite-card" style={{ marginTop: 32, padding: 32 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              ...
              >
                Umumiy pul aylanmasi va platforma ulushi
              </p>
            </div>
          </div>
          <div style={{ display: "flex", gap: 6 }}>
            {[...PERIOD_OPTIONS, { label: "Barchasi", value: "all" }].map(
              (opt) => (
                <button
                  key={opt.value}
        ...
        {revenueChartData.length > 0 && (
          <div style={{ marginTop: 32 }}>
            ...
            >
              Taassurotlar va kliklar dinamikasi
            </h4>
